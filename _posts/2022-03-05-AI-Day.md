...
Les transformers sont une architecture complexe du deep learning qui se présente comme l'état de l'art dans beaucoup de domaines. Que se passerait-il si cette architecture était appliqué à la détection de cyber attaques ? C'est à cette question que répond Sharkticon, un système de détection d'intrusion basé sur de l'anomalie détection grâce aux Transformers ! Ce projet réalisé par POC a été supervisé par Maxime Labonne chercheur en deep learning à Airbus Defense.
